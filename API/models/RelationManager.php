...
class RelationManager extends Model{
    ...
    public function getByCharacters(int $id) {
        $sql = 'SELECT r.titre,r.description,p.nom as cible , p.type,r.id_p2 FROM relations r JOIN personnages p ON r.id_p2 = p.id WHERE id_p1 = ?';  // Remplacez par le nom de votre table Pokemon
